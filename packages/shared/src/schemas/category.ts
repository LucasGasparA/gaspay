...
export const defaultCategories: ReadonlyArray<{
  ...
  { name: 'Assinaturas', icon: 'repeat', color: '#820AD1', kind: 'expense' },
  { name: 'Compras', icon: 'shopping-bag', color: '#0AB5B5', kind: 'expense' },
  { name: 'Contas', icon: 'file-text', color: '#5A078F', kind: 'expense' },
  ...
  { name: 'Rendimentos', icon: 'trending-up', color: '#820AD1', kind: 'income' },
